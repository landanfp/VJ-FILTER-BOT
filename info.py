...
BOT_TOKEN = environ.get('BOT_TOKEN', "5088657122:AAGXARfg6sSX1p1ge876jknkrJizwH959b4")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001792962793') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001792962793')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://abirhasan2005:abirhasan@cluster0.i6qzp.mongodb.net/cluster0?retryWrites=true&w=majority")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'haaaaarki) # owner username without @
